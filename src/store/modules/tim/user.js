...
const user = {
  state: {
    currentUserProfile: {},
    isLogin: sessionStorage.getItem('imIsLogin') ? sessionStorage.getItem('imIsLogin') : false,
    isSDKReady: sessionStorage.getItem('isSDKReady') ? sessionStorage.getItem('isSDKReady') : false // TIM SDK 是否 ready
  },
  mutations: {
    ...
    toggleIsLogin(state, isLogin) {
      ...
      sessionStorage.setItem('imIsLogin', isLogin)
    },
    toggleIsSDKReady(state, isSDKReady) {
      state.isSDKReady = typeof isSDKReady === 'undefined' ? !state.isSDKReady : isSDKReady
      sessionStorage.setItem('isSDKReady', isSDKReady)
    },
    reset(state) {
      Object.assign(state, {
        currentUserProfile: {},
