<template>
  <div>
    <el-form ref="createGroupForm" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="群类型">
        <el-select v-model="form.type">
          ...
          <el-option label="ChatRoom" value="ChatRoom" />
          <el-option label="AVChatRoom" value="AVChatRoom" />
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="群简介">
        <el-input v-model="form.introduction" type="textarea" :maxlength="240" />
      </el-form-item>
      <el-form-item label="群公告">
        <el-input v-model="form.notification" type="textarea" :maxlength="300" />
      </el-form-item>
